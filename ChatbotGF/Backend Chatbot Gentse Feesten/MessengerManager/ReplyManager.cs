...
namespace Chatbot_GF.MessengerManager
{
    public class ReplyManager
    {
        ...
        public void SendWelcomeMessage(long id,string lang)
        {
            ...
            reply.Add(new QuickReply("text", DataConstants.GetMessage("Search_location", lang), "SEND_LOCATION_CHOICE"));
            reply.Add(new QuickReply("text", DataConstants.GetMessage("Search_Date", lang), "SEND_DATE_CHOICE"));
        ...
        {
            List<SimpleQuickReply> reply = new List<SimpleQuickReply>();
            reply.Add(new QuickReply("text", DataConstants.GetMessage("Choose_list", lang), "GET_EVENT_HERE_NOW°0"));
            reply.Add(new QuickReply("text", DataConstants.GetMessage("Choose_card", lang), "GET_USER_LOCATION"));
        ...
        {
            List<SimpleQuickReply> reply = new List<SimpleQuickReply>();
            reply.Add(new QuickReply("text", DataConstants.GetMessage("Yes", lang), $"DEVELOPER_DEFINED_LOCATION°{loc.Name}"));
            reply.Add(new QuickReply("text", DataConstants.GetMessage("No", lang), "SEND_LOCATION_CHOICE"));
        ...
        public void SendLocationQuery(long id, int page, string lang)
        {
            try
            {
                ...
                if(page == 0)
                {
                    reply.Add(new QuickReply("text", DataConstants.GetMessage("More", lang), "GET_EVENT_HERE_NOW°" + 1));
                }
                else
                {
                    reply.Add(new QuickReply("text", DataConstants.GetMessage("Previous", lang), "GET_EVENT_HERE_NOW°" + (page - 1)));
                }
        ...
        {
            List<SimpleQuickReply> reply = new List<SimpleQuickReply>();
            reply.Add(new QuickReply("text", DataConstants.GetMessage("Yes", lang), "SEND_LOCATION_CHOICE"));
            reply.Add(new QuickReply("text", DataConstants.GetMessage("No", lang), "DEVELOPER_DEFINED_SEARCHFALSE"));
        ...
        public void SendDayOption(long id, string lang)
        {
            ...
            reply.Add(new QuickReply("text", DataConstants.GetMessage("Previous_Block", lang), "SEND_DATE_CHOICE"));
        ...
        public void SendTimePeriod(long id, string value, string lang)
        {
            ...
            reply.Add(new QuickReply("text", DataConstants.GetMessage("Previous_Block", lang), "DEVELOPER_DEFINED_DATE_SPECIFIC"));
        ...
        {
            List<SimpleQuickReply> reply = new List<SimpleQuickReply>();
            reply.Add(new QuickReply("text", DataConstants.GetMessage("Now", lang), "DEVELOPER_DEFINED_LOCATION°ALL"));
            reply.Add(new QuickReply("text", DataConstants.GetMessage("Choice_For_Date", lang), "DEVELOPER_DEFINED_DATE_SPECIFIC"));
        ...
        public void SendHoursChoice(long id, string looping, string value, string lang)
        {
            ...
            reply.Add(new QuickReply("text", DataConstants.GetMessage("Previous_Block", lang), "DEVELOPER_DEFINED_DAY°" + value));
            GenericMessage message = new GenericMessage(id, DataConstants.GetMessage("Time_Periods", lang), reply);
